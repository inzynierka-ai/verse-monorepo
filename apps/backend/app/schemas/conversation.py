...
class ProcessingStatusMessage(BaseModel):
    ...
    step: Literal["moderating", "extracting_entities",
                  "searching_vectors", "building_prompt", "generating_response"]
    message: str
    debug_info: Optional[Union[ModerationResult, EntityExtractionResult,
                               VectorSearchResult, Dict[str, Any]]] = None
...
ServerMessage = Union[ChatChunkMessage, ChatCompleteMessage,
                      ErrorMessage, ProcessingStatusMessage]
