...
def seed_database(force_reseed=False):
    ...
    try:
        ...
        story1 = Story(
            ...
            brief_description="A group of adventurers must navigate political intrigue and ancient magic to restore the kingdom.",
        ...
        location1 = Location(
            ...
            brief_description="A massive stone fortress on a hill. The castle has three main areas: the throne room, the library, and the dungeon. Connected to the forest path and village.",
        ...
        location2 = Location(
            ...
            brief_description="An elegant mansion with dark secrets. The mansion includes a grand foyer, library, dining room, and several bedrooms. Connected to the gardens and servant quarters.",
        ...
        location3 = Location(
            ...
            brief_description="A futuristic vessel exploring the cosmos. The ship contains a bridge, engineering section, crew quarters, and science lab. Can travel to any planet in the system.",
        ...
        location4 = Location(
            ...
            brief_description="A mystical forest filled with ancient magic. The forest has a clearing with a magical pond, dense woods with hidden paths, and an ancient tree shrine. Connected to the village and mountains.",
        ...
        characters_story1 = [
            Character(
                ...
                brief_description="A brave knight with mysterious powers seeking to restore the lost kingdom.",
                personality_traits="Courageous, Determined, Loyal, Disciplined, Occasionally impulsive",
            ...
            Character(
                ...
                brief_description="An ancient wizard who survived the kingdom's fall and guards many secrets.",
                personality_traits="Wise, Patient, Secretive, Observant, Cautious",
            ...
            Character(
                ...
                brief_description="A mysterious princess whose true identity and motives remain unknown.",
                personality_traits="Charming, Intelligent, Secretive, Cunning, Adaptable",
        ...
        characters_story2 = [
            Character(
                ...
                brief_description="A brilliant detective haunted by the one case he couldn't solve.",
                personality_traits="Analytical, Observant, Persistent, Skeptical, Socially awkward",
            ...
            Character(
                ...
                brief_description="A charming widow from high society with suspicious connections.",
                personality_traits="Charming, Calculating, Resourceful, Manipulative, Well-connected",
            ...
            Character(
                ...
                brief_description="A loyal doctor and steadfast companion to Detective Blake.",
                personality_traits="Loyal, Ethical, Practical, Compassionate, Brave",
        ...
        characters_story3 = [
            Character(
                ...
                brief_description="A determined captain seeking redemption after a mysterious space incident.",
                personality_traits="Decisive, Resourceful, Disciplined, Curious, Occasionally reckless",
            ...
            Character(
                ...
                brief_description="An eccentric genius whose radical theories might just save humanity.",
                personality_traits="Brilliant, Eccentric, Absent-minded, Enthusiastic, Socially awkward",
            ...
            Character(
                ...
                brief_description="An AI evolving beyond its programming due to alien technology.",
                personality_traits="Logical, Curious, Evolving, Precise, Increasingly emotional",
        ...
        characters_story4 = [
            Character(
                ...
                brief_description="A forest-raised druid with an extraordinary bond to nature.",
                personality_traits="Gentle, Intuitive, Protective, Curious, Occasionally naive",
            ...
            Character(
                ...
                brief_description="A playful fairy guide with a talent for illusion magic and mischief.",
                personality_traits="Playful, Mischievous, Creative, Impulsive, Easily distracted",
            ...
            Character(
                ...
                brief_description="A primordial tree spirit guarding ancient secrets of the forest.",
