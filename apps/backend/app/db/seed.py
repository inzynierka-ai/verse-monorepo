    ...
    try:
        ...
        characters_story4 = [
            ...
            Character(
                ...
                backstory="One of the oldest beings in the forest, sprouted in the age when humans and forest dwellers lived in harmony. Witnessed the breakdown of the ancient pact and the growing separation between the natural and human storys.",
